...
import { uuid } from '/_necronomicon/naming.js';
...
export async function main(ns: NS): Promise<void> {
    ...
    notifyCultLeader(ns, log, cultRecruits, hacknetRecruits)
}
 ...
 */
export async function notifyCultLeader(ns: NS, log: Logger, cultRecruits: number, hacknetRecruits: HacknetRecruits): Promise<void> {
